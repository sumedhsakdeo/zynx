...
main(int argc, char **argv)
{
    ...
    std::cout << "Got the client object" << std::endl;
    ...
    std::cout << "Created directory ctest";
    ...
    cout << "Read dir returned: " << std::endl;
...
*/
    ...
    int fd1 = gKfsClient->Create(tempFn.c_str(),3,false,"GMAIL:helloWorld:read");
